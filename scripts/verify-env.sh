...
_PLACEHOLDER_LEGIT='^\./scripts/verify-env\.sh$|^\./scripts/tests/verify-env\.bats$|^\./scripts/checks/110-lint-format-invariants\.sh$|^\./AGENTS\.md$|^\./\.github/prompts/.*|^\./\.github/agents/.*\.agent\.md$|^\./\.github/ISSUE_TEMPLATE/agent_init\.md$|^\./.*\.template$|^\./.*_template\.md$|^\./\.context/rules/process_template_detection\.md$|^\./docs/decisions/adr-001-context-pack-structure\.md$'
