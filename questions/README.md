...
|---|---|---|---|
| `domain-1-education` | `batch-01`–`05` | `cctc-1001`–`1021` | 21 |
| `domain-2-pretx` | `batch-01`–`05` | `cctc-2001`–`2020` | 20 |
| `domain-3-postop` | `batch-01`–`05` | `cctc-3001`–`3020` | 20 |
