...
|---|---|---|---|
| `domain-1-education` | `batch-01`–`03` | `cctc-1001`–`1013` | 13 |
| `domain-2-pretx` | `batch-01`–`03` | `cctc-2001`–`2012` | 12 |
| `domain-3-postop` | `batch-01`–`03` | `cctc-3001`–`3012` | 12 |
