...
|---|---|---|---|
| `domain-1-education` | `batch-01`–`14` | `cctc-1001`–`1057` | 57 |
| `domain-2-pretx` | `batch-01`–`14` | `cctc-2001`–`2056` | 56 |
| `domain-3-postop` | `batch-01`–`14` | `cctc-3001`–`3056` | 56 |
