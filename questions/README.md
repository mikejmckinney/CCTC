...
|---|---|---|---|
| `domain-1-education` | `batch-01`–`13` | `cctc-1001`–`1053` | 53 |
| `domain-2-pretx` | `batch-01`–`13` | `cctc-2001`–`2052` | 52 |
| `domain-3-postop` | `batch-01`–`13` | `cctc-3001`–`3052` | 52 |
