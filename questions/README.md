...
|---|---|---|---|
| `domain-1-education` | `batch-01`–`11` | `cctc-1001`–`1045` | 45 |
| `domain-2-pretx` | `batch-01`–`11` | `cctc-2001`–`2044` | 44 |
| `domain-3-postop` | `batch-01`–`11` | `cctc-3001`–`3044` | 44 |
