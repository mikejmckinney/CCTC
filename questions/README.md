...
|---|---|---|---|
| `domain-1-education` | `batch-01`–`15` | `cctc-1001`–`1061` | 61 |
| `domain-2-pretx` | `batch-01`–`15` | `cctc-2001`–`2060` | 60 |
| `domain-3-postop` | `batch-01`–`15` | `cctc-3001`–`3060` | 60 |
