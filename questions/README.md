...
|---|---|---|---|
| `domain-1-education` | `batch-01`–`04` | `cctc-1001`–`1017` | 17 |
| `domain-2-pretx` | `batch-01`–`04` | `cctc-2001`–`2016` | 16 |
| `domain-3-postop` | `batch-01`–`04` | `cctc-3001`–`3016` | 16 |
