...
- **49 draft items** in `questions/domain-*/batch-01.json` through `batch-04.json` (IDs `cctc-1001`–`1017`, `2001`–`2016`, `3001`–`3016`).
...
- Expand the real question bank under domain directories (batch 05+)
