...
- **121 draft items** in `questions/domain-*/batch-01.json` through `batch-10.json` (IDs `cctc-1001`–`1041`, `2001`–`2040`, `3001`–`3040`).
...
- Expand the real question bank under domain directories (batch 11+)
