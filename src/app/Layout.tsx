...
export function Layout() {
  const { activeSession, theme, toggleTheme } = useApp();

  const navItems = [
    { to: '/', label: 'Dashboard', icon: <HomeIcon /> },
    { to: '/setup', label: 'Setup', icon: <GearIcon /> },
    { to: '/history', label: 'History', icon: <ChartIcon /> },
    ...(activeSession && !activeSession.submittedAt ? [{ to: '/session', label: 'Resume', icon: <PlayIcon /> }] : []),
  ];
    ...
    <div className="app-shell">
      <header className="app-header" role="banner">
        ...
        <nav className="app-header__nav" aria-label="Primary">
          ...
          >
            <FlagIcon />
            <span className="app-header__nav-label">Reported</span>
          </NavLink>
        </nav>
