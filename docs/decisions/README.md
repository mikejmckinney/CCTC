...
| [ADR-026](./adr-026-compliance-contracts.md) | Agent compliance contracts and role receipt evidence | Superseded by ADR-032 |
...
| [ADR-032](./adr-032-retire-compliance-schema-subsystem.md) | Retire the serialized compliance-schema subsystem | Accepted |
